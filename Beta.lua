...
G2L["1"]["ZIndexBehavior"] = Enum.ZIndexBehavior.Sibling -- Fixes the layering bug
...
-- [[ 5. PANEL (FIXED VISIBILITY) ]] --
G2L["89"] = Instance.new("Frame", G2L["7a"]); -- Changed to Frame to stop CanvasGroup bug
G2L["89"]["Name"] = [[Panel]];
G2L["89"]["ZIndex"] = 10; -- Sibling mode handles the rest
